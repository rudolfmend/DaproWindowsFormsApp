...
namespace DaproWindowsFormsApp
{
    public partial class DataViewerForm : Form
    {
        ...
        private void ButtonPatientsOpenFolder_Click(object sender, EventArgs e)
        {
        ...
        private void ButtonDiagnosesOpenFolder_Click(object sender, EventArgs e)
        {

        }

        private void ButtonNavigateToAddPatientForm_Click(object sender, EventArgs e)
        {
    
            var addPatientForm = new AddPatientForm();
            addPatientForm.Closed += (s, args) => this.Close();
            addPatientForm.Show();
        }
        ...
        private void ButtonSettings_Click(object sender, EventArgs e)
        {
            ...
            addRecordForm.Closed += (s, args) => this.Close();
            addRecordForm.Show();
        }
    }
}
