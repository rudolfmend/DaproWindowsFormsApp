...
// C:\Users\rudol\source\repos\DaproWindowsFormsApp\DaproWindowsFormsApp\RemoveSelectedRow.cs
...
namespace DaproWindowsFormsApp
{
    internal class RemoveSelectedRow
    {
        ...
        private readonly string ConnectionString; // Add this line to define the ConnectionString field
        private readonly string currentTable; // Add this line to define the currentTable field
        private readonly ToolStripStatusLabel statusLabel2; // Add this line to define the statusLabel2 field
        ...
        public void RemoveRow()
        {
            try
            {
                    ...
                    dataGridViewShowTableData.SelectedRows[0] != null)
                {
                    ...
                    {
                        if (dataGridViewShowTableData.DataSource is BindingSource bindingSource)
                        {
